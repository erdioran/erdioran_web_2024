...
public class ExtentManager {
  ...
  static {
    ...
    htmlReporter.config().setReportName("Kariyer Automation Test Report");
    htmlReporter.config().setDocumentTitle("Kariyer Automation Results");
    ...
    EXTENT_REPORTS.setSystemInfo("Environment", DataManager.getData("url.base"));
