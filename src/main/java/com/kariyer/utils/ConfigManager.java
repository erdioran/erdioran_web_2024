...
public class ConfigManager {
    ...
    private static final String TEST_CONFIG_FILE = Paths.get("src/test/resources/test.properties").toString();
    ...
    public static String getTestUrlConfig() {
        return System.getProperty("testEnv", getStringValue("testEnv", "prod"));
    }
